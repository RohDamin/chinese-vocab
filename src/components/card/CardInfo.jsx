...
export function CardInfo({ word, showAnswer, onReveal }) {
    ...
    return (
      <div style={{ padding: "20px 24px", textAlign: "center" }}>
        ...
        {/* 예문 */}
        <div style={{ fontSize: 11, color: "#F57C20", fontWeight: 600, marginBottom: 8, letterSpacing: 1 }}>
          예 문
        </div>
        <div
          onClick={() => speak(word.example)}
          style={{ fontSize: 18, fontWeight: 600, color: "#333", marginBottom: 4, cursor: "pointer", lineHeight: 1.5 }}
        >
